...
export function ShortCard({ video, onPlay, index }: ShortCardProps) {
  ...
  return (
    ...
    >
      <Card
        className="overflow-hidden bg-zinc-900 border-zinc-800 hover:border-red-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/10 max-w-[180px] mx-auto p-0"
